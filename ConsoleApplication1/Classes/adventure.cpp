...
adventure::adventure(): clearable(new std::string("The king needs your help you need to go to the cave"),
    new std::string("The king really appreciate and gives you a medal"))
{
...
adventure::adventure(const adventure& other) : clearable(nullptr,nullptr)
{
}
